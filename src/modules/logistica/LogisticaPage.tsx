...
import { UpdateDeliveryStatusDialog } from "@/app/(dashboard)/logistica/_components/UpdateDeliveryStatusDialog";
...
export default function LogisticaPage() {
  ...
  const [isEntregaFormOpen, setIsEntregaFormOpen] = React.useState(false);
  ...
  return (
    <div className="space-y-6">
        ...
        <TabsContent value="entregas" className="mt-4">
          <div className="space-y-4">
            <div className="flex flex-wrap justify-end items-center gap-2">
              ...
              <Button onClick={() => setIsEntregaFormOpen(true)}><PlusCircle className="mr-2 h-4 w-4" /> Nova Entrega</Button>
            </div>
            <AdvancedFilters 
      ...
      {/* Dialog for EntregaForm */}
      <Dialog open={isEntregaFormOpen} onOpenChange={setIsEntregaFormOpen}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            <DialogTitle>Criar Nova Entrega</DialogTitle>
            <DialogDescription>Preencha os detalhes abaixo.</DialogDescription>
          </DialogHeader>
          <EntregaForm onSuccess={handleDeliverySuccess} />
        </DialogContent>
      </Dialog>
